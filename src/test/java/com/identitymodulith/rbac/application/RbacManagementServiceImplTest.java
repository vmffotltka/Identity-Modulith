...
class RbacManagementServiceImplTest {
    ...
    void testCreateRole_Success() {
        ...
        // When
        var result = rbacManagementService.createRole(request, userId);
    ...
    void testCreateRole_Duplicate() {
        ...
        // When & Then
        assertThrows(RbacException.class, () -> {
            rbacManagementService.createRole(request, userId);
        });
    }
    ...
    void testCreatePermission_Success() {
        ...
        // When
        var result = rbacManagementService.createPermission(request, userId);
    ...
    void testAssignPermissionToRole_Success() {
        ...
        // When
        rbacManagementService.assignPermissionToRole("ADMIN", "user:manage", userId);
    ...
    void testRevokePermissionFromRole_Success() {
        ...
        // When
        rbacManagementService.revokePermissionFromRole("ADMIN", "user:manage", userId);
